...
<div class="task-table-card">
	...
	async load_filter_options() {
		const r = await frappe.call({
			method: "tnc_v2_360ithub.tnc_v2.page.task_dashboard.task_dashboard.get_filter_options"
		});
	...
	async load(append = false) {
		...
		const r = await frappe.call({
			method: "tnc_v2_360ithub.tnc_v2.page.task_dashboard.task_dashboard.get_dashboard_data",
			args: {
	...
	async load_leaderboard() {
		...
		const r = await frappe.call({
			method: "tnc_v2_360ithub.tnc_v2.page.task_dashboard.task_dashboard.get_leaderboard_data",
			args: {
				filters: this.filters,
	...
	async open_comment_dialog(task_name) {
		const r = await frappe.call({
			method: "tnc_v2_360ithub.tnc_v2.page.task_dashboard.task_dashboard.get_task_comments",
			args: { task_name }
		});
		...
		let d = new frappe.ui.Dialog({
			...
			primary_action: async () => {
				...
				await frappe.call({
					method: "tnc_v2_360ithub.tnc_v2.page.task_dashboard.task_dashboard.add_task_comment",
	...
	export_tasks() {
		...
		frappe.call({
			method: "tnc_v2_360ithub.tnc_v2.page.task_dashboard.task_dashboard.export_tasks",
			args: { filters },
			callback: function (r) {
