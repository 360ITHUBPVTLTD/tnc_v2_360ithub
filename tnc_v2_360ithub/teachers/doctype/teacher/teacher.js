...
// 						frappe.call({
// 							method: "tnc_v2_360ithub.teachers.doctype.teacher.teacher.get_unpaid_timesheets",
// 							args: {
...
// 			frappe.call({
// 				method: "tnc_v2_360ithub.teachers.doctype.teacher.teacher.create_purchase_order_for_selected_timesheets",
// 				args: {
// 					teacher_name: frm.doc.name,
...
// 	frappe.call({
// 		method: "tnc_v2_360ithub.teachers.doctype.teacher.teacher.get_teacher_payments",
// 		args: {
...
// 	frappe.call({
// 		method: "tnc_v2_360ithub.teachers.doctype.teacher.teacher.get_teacher_timesheets_for_portal",
// 		args: {
// 			teacher_id: frm.doc.name,
// 			start_date: start_date,
// 			end_date: end_date,
...
function show_outstanding_invoice_dialog(frm) {
    frappe.call({
        method: "tnc_v2_360ithub.teachers.doctype.teacher.teacher.get_outstanding_invoices_with_items",
        ...
        callback: function (r) {
            ...
            let dialog = new frappe.ui.Dialog({
                ...
                primary_action: function () {
                    ...
                    frappe.call({
                        method: "tnc_v2_360ithub.teachers.doctype.teacher.teacher.create_payment_for_invoices_v2",
                        args: {
                            teacher_id: frm.doc.name,
...
function execute_status_update(name, status, reason = null) {
    frappe.call({
        method: "tnc_v2_360ithub.teachers.doctype.teacher.teacher.update_timesheet_status",
        args: {
            name: name,
...
function render_selection_dialog(frm, timesheets, start_date, end_date) {
    let dialog = new frappe.ui.Dialog({
        ...
        primary_action: function () {
            ...
            frappe.call({
                method: "tnc_v2_360ithub.teachers.doctype.teacher.teacher.create_invoice_from_timesheets",
                args: {
                    teacher_name: frm.doc.name,
